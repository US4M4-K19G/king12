...
if key == '1':
    ...
    with open('Usama.txt', 'w') as file:
        for password in passwords:
            file.write(f'{password}\n')

    print(f'\n{F}Passwords saved in \'Usama.txt\'')

elif key == '2':
    r = requests.Session()
    file = input('\x1b[2;36m[\x1b[1;33m~\x1b[2;36m] Enter Password List (Usama.txt): ' + Z)
    ...
    file_path = input(B + 'Enter Password List (Usama.txt): ' + X)
